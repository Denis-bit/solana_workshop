...
pub struct MakeOffer<'info> {
    ...
    #[account(
        mut,
        associated_token::mint = token_min_a, 
        asscoiated_token::authority = maker,
    ...
    #[account(
        ...
        associated_token::token_prgram = token_program
    )]
...
pub fn send_offered_tokens_to_vault(
    ...
    token_a_offered_ammount: u64,
) -> Result<()> {
    let transfer_accounts = TransferChecker {
